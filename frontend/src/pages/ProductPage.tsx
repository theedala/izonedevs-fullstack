          ...
          <div>
            ...
            <div className="bg-green-600/20 border border-green-600/30 rounded-lg p-4 mb-6">
              <p className="text-white mb-2">
                Add this item to your cart and checkout multiple items at once, or order directly via WhatsApp.
              </p>
            </div>
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 px-6 py-3 rounded-lg text-white bg-gradient-to-r from-primary to-secondary hover:shadow-neon transition-all duration-300 font-medium flex items-center justify-center gap-2 ${!product.is_available ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
              ...
              <a 
                ...
                className={`flex-1 inline-flex items-center justify-center px-6 py-3 rounded-lg text-white bg-green-600 hover:bg-green-700 transition-colors font-medium ${!product.is_available ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''}`}
              >
